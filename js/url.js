...
var apiUrl = {
  ...
  // 质量代码
  loginQC: str + 'user/user_quality_tracking/login',
  auth_rules_page: str + 'user_quality_tracking/auth_rules_page',
  tech_create_order: str + 'tech_service_reg/create_order',
  tech_order_page: str + 'tech_service_reg/order_page',
  order_page: str + 'device_fail_reg/order_page',
  checkTokenQC: str + 'user_quality_tracking/check_token',
  create_order: str + 'device_fail_reg/create_order',
  create_lists_order: str + 'device_fail_reg/create_lists_order',
  tech_edit_order: str + 'tech_service_reg/edit_order'
};
